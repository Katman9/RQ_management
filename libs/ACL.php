...
class ACL
{
	...
	public static $role_pages = array(
			'administrator' =>
						array(
							'employee' => array('list','view','add','edit', 'editfield','delete','import_data','userregister','accountedit','accountview'),
							'finance' => array('list','view','add','edit', 'editfield','delete','import_data','paid','cancelled','awaiting_payment'),
							'requests' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'works_on' => array('list','view','add','edit', 'editfield','delete','import_data')
						),
		
			'finance' =>
						array(
							'finance' => array('list','view','add','edit', 'editfield','import_data','paid','cancelled','awaiting_payment'),
							'requests' => array('list','view')
						),
		
			'technical' =>
						array(
							'finance' => array('paid','cancelled','awaiting_payment'),
							'requests' => array('list','view','add'),
							'works_on' => array('list','view','add','edit', 'editfield','import_data')
						),
		
			'lands' =>
						array(
							'finance' => array('paid','cancelled','awaiting_payment'),
							'requests' => array('list','view','add','edit', 'editfield','import_data')
						)
		);
