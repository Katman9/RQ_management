                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-user_id"  value="<?php  echo $data['user_id']; ?>" type="text" placeholder="Enter User Id"  required="" name="user_id"  data-url="api/json/account_user_id_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-phone_no"  value="<?php  echo $data['phone_no']; ?>" type="number" placeholder="Enter Phone No" step="1"  required="" name="phone_no"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <select required=""  id="ctrl-department_name" name="department_name"  placeholder="Select a value ..."    class="custom-select" >
                                                                            ...
                                                                            $field_value = $data['department_name'];
