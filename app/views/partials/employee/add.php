            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="employee-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("employee/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-user_id"  value="<?php  echo $this->set_field_value('user_id',""); ?>" type="text" placeholder="Enter User Id"  required="" name="user_id"  data-url="api/json/employee_user_id_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                <div class="col-sm-4">
                                                                    <label class="control-label" for="email_address">Email Address <span class="text-danger">*</span></label>
                                                                </div>
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-email_address"  value="<?php  echo $this->set_field_value('email_address',""); ?>" type="email" placeholder="Enter Email Address"  required="" name="email_address"  data-url="api/json/employee_email_address_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
                                                                            <div class="check-status"></div> 
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="form-group ">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <input id="ctrl-phone_no"  value="<?php  echo $this->set_field_value('phone_no',""); ?>" type="number" placeholder="Enter Phone No" step="1"  required="" name="phone_no"  class="form-control " />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <select required=""  id="ctrl-department_name" name="department_name"  placeholder="Select a value ..."    class="custom-select" >
                                                                                    <option value="">Select a value ...</option>
                                                                                    <?php
                                                                                    $department_name_options = Menu :: $department_name;
                                                                                    if(!empty($department_name_options)){
                                                                                    foreach($department_name_options as $option){
                                                                                    $value = $option['value'];
                                                                                    $label = $option['label'];
                                                                                    $selected = $this->set_field_selected('department_name', $value, "");
                                                                                    ?>
